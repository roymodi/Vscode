...
def data_scraper(request_method, url, **kwargs):
    while True:
        try:
            ...
            response = requests.request(request_method, url, proxies=proxy, timeout=7,headers=None,**kwargs)
            break
...
url='https://www.nse.com'
web=data_scraper('get',url)
